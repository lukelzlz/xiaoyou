...
1. **真实服务集成**
   - OCR: 接入 Google Vision / Azure Computer Vision
   - ASR: 接入 Whisper / Azure Speech
   - 文档: 接入 pdf-parse / mammoth
